...
pkglibexecdir = $(libexecdir)/apache-couchdb
...
CONFIG_CLEAN_FILES = src/snappy/google-snappy/snappy-stubs-public.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/config.h.in \
	...
	$(top_srcdir)/src/snappy/google-snappy/config.h.in \
	$(top_srcdir)/src/snappy/google-snappy/snappy-stubs-public.h.in \
	AUTHORS INSTALL THANKS build-aux/compile \
...
ACLOCAL = ${SHELL} /Users/shrivatsa/Documents/Code/CouchDB/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AS = as
AUTOCONF = ${SHELL} /Users/shrivatsa/Documents/Code/CouchDB/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /Users/shrivatsa/Documents/Code/CouchDB/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /Users/shrivatsa/Documents/Code/CouchDB/build-aux/missing automake-1.15
AWK = awk
CC = gcc
...
ERLANG_FLAGS = -I${exec_prefix}/lib/erlang/usr/include -I/usr/lib/erlang/usr/include -I/usr/local/lib/erlang/usr/include -I/opt/local/lib/erlang/usr/include
...
ICU_CPPFLAGS = -I/usr/local/Cellar/icu4c/57.1/include 
ICU_CXXFLAGS = --std=c++0x 
ICU_LIBS =  -L/usr/local/Cellar/icu4c/57.1/lib -licui18n -licuuc -licudata  
...
JS_CFLAGS = -DXP_UNIX -I/usr/local/Cellar/spidermonkey/1.8.5_1/include/js -I/usr/local/Cellar/nspr/4.12_1/include/nspr
JS_LIBS = -lmozjs185 -lm -L/usr/local/Cellar/spidermonkey/1.8.5_1/lib -L/usr/local/Cellar/nspr/4.12_1/lib -lmozjs185 -lplds4 -lplc4 -lnspr4
JS_LIB_BINARY = 
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /Users/shrivatsa/Documents/Code/CouchDB/build-aux/missing makeinfo
MANIFEST_TOOL = :
...
PACKAGE_STRING = Apache CouchDB 1.6.4
...
STRIP = strip
VERSION = 1.6.4
abs_builddir = /Users/shrivatsa/Documents/Code/CouchDB
abs_srcdir = /Users/shrivatsa/Documents/Code/CouchDB
abs_top_builddir = /Users/shrivatsa/Documents/Code/CouchDB
abs_top_srcdir = /Users/shrivatsa/Documents/Code/CouchDB
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
initdir = 
install_sh = ${SHELL} /Users/shrivatsa/Documents/Code/CouchDB/build-aux/install-sh
...
src/snappy/google-snappy/config.h: src/snappy/google-snappy/stamp-h2
	@test -f $@ || rm -f src/snappy/google-snappy/stamp-h2
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/snappy/google-snappy/stamp-h2

src/snappy/google-snappy/stamp-h2: $(top_srcdir)/src/snappy/google-snappy/config.h.in $(top_builddir)/config.status
	@rm -f src/snappy/google-snappy/stamp-h2
	cd $(top_builddir) && $(SHELL) ./config.status src/snappy/google-snappy/config.h

distclean-hdr:
	-rm -f config.h stamp-h1 src/snappy/google-snappy/config.h src/snappy/google-snappy/stamp-h2
src/snappy/google-snappy/snappy-stubs-public.h: $(top_builddir)/config.status $(top_srcdir)/src/snappy/google-snappy/snappy-stubs-public.h.in
...
install-localdocDATA: $(localdoc_DATA)
	...
	if test -n "$$list"; then \
	  echo " $(MKDIR_P) '$(DESTDIR)$(localdocdir)'"; \
	  $(MKDIR_P) "$(DESTDIR)$(localdocdir)" || exit 1; \
	fi; \
	for p in $$list; do \
...
.PHONY: $(am__recursive_targets) CTAGS GTAGS TAGS all all-am \
	...
	install-info-am install-localdocDATA install-man install-pdf \
	install-pdf-am install-ps install-ps-am install-strip \
	installcheck installcheck-am installdirs installdirs-am \
	maintainer-clean maintainer-clean-generic mostlyclean \
	mostlyclean-generic mostlyclean-libtool pdf pdf-am ps ps-am \
	tags tags-am uninstall uninstall-am uninstall-localdocDATA
